    ...
    return (
        <nav className="flex flex-row items-center justify-between" style={{backgroundColor: "#0B0B45"}}>
            ...
            <div className="flex flex-row items-center justify-between w-28">
                <Icon type="dark" className="text-white" />
                <span className="text-white dark:text-white">
                    <ExpandIcon type="flag" className="flex flex-row items-end h-8 scale-150 ml-3 pb-1 pl-1" expandClassName="scale-50 -ml-2.5 -mb-1.5"/>
                </span>
            </div>
            <div className="flex flex-row items-center justify-between mr-2 w-44" >
                ...
                <ExpandIcon type="cart" className="flex flex-row items-end h-8 scale-150 ml-3 pb-1 pl-1 text-white" expandClassName="scale-50 -ml-2.5 -mb-1.5" />
            </div>
        </nav>
    )
}
